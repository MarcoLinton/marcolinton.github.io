...
The database contains all $Aut(F(\Sigma))$ representatives up to length 8 and all $Aut(F(\Sigma))$ representatives where $\vert \Sigma\vert = 2$ up to length 14. If you have any suggestions for improving the database or would like to contribute new entries, feel free to drop me an email.
